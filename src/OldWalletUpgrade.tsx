        ...
        >
            <div className='bg-attention dark:bg-attentiondark m-4 flex max-w-2xl flex-col items-center rounded-2xl p-4 shadow-sm'>
                ...
                <p className='max-w-xl px-4 py-2'>
                    Press the &quot;Upgrade&quot; button below to automatically unstake from the old version and stake
                    in the new version.
                </p>
                <p className='max-w-xl px-4 py-2'>
                    You have <b>{model.oldWalletTokensFormatted}</b> in the old version. After upgrading, you&apos;ll
                    receive <b>{model.newWalletTokensFormatted}</b> in the new version.
                </p>
                <button
